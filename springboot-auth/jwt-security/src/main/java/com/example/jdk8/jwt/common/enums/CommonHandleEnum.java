...
import com.example.jdk8.exceptins.BaseErrorInfoInterface;
 ...
 */
public enum CommonHandleEnum implements BaseErrorInfoInterface {
    ...
    CommonHandleEnum(Integer resultCode, String resultMsg) {
